...
export const COLOR_THEMES = [
  { name: 'Синий',      key: 'blue',   primary: '#2080f0', hover: '#4098fc', pressed: '#1060c9', suppl: '#4098fc' },
  { name: 'Зелёный',    key: 'green',  primary: '#18a058', hover: '#36ad6a', pressed: '#0c7a43', suppl: '#36ad6a' },
  { name: 'Красный',    key: 'red',    primary: '#d03050', hover: '#de576b', pressed: '#ab1f3f', suppl: '#e06080' },
  { name: 'Оранжевый',  key: 'orange', primary: '#f0a020', hover: '#fcb040', pressed: '#c97c10', suppl: '#fcb040' },
  { name: 'Фиолетовый', key: 'purple', primary: '#722ed1', hover: '#9254de', pressed: '#531dab', suppl: '#9254de' },
  { name: 'Бирюзовый',  key: 'teal',   primary: '#0eb0a9', hover: '#36b8b3', pressed: '#07877f', suppl: '#36b8b3' },
  { name: 'Розовый',    key: 'pink',   primary: '#eb2f96', hover: '#f759ab', pressed: '#c41d7f', suppl: '#f759ab' },
]
